...
// So, I copied this from the commons as I do not want to depend on anything from it. Avoiding transitive dependencies.
// That might be copied from the go.module, that is not ideal as we are adding bloat to the module.
